...
data_loader = Loader(
    preprocessors=[
        LabelsCon(),
        VideoLoadPrep(n_frames=n_frames, rand_middle_frame=False, rgb=n_channels>1),
...
validate_every_n_samples = 2*1024 #20*1024
...
def build_model():
    ...
    l_forw = lstm(l, num_units=128)
    # l_back = lstm(l, num_units=128, backwards=True)
